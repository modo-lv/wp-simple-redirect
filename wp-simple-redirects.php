<?php
/*
Plugin Name: Simple Redirects for WordPress
Plugin URI: https://github.com/modo-lv/wp-simple-redirects
Description: A fork of Scott Nellé's "Simple 301 Redirects" WordPress plugin.
Version: 1.07.1
Author: modo_lv
Author URI: http://modo.lv/
...
if (!class_exists("SimpleRedirects")) {
	...
	class SimpleRedirects {
		...
		function create_menu() {
		  add_options_page('Simple Redirects', 'Simple Redirects', 'manage_options', 'redirect_options', array($this,'options_page'));
		}
		...
		function redirect() {
			...
			$userrequest = parse_url($this->get_address())["path"];
